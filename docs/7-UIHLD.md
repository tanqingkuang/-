...
- 正式地形采用三层融合消除有限地图的矩形硬边：配置范围内保留原分辨率高精网格，每侧追加 40 个径向采样并以至少 8 倍跨度形成不透明低密外围地面，其半径不得小于 120 km，高度和颜色平滑收敛到天际色；外围边界必须越过相机远裁剪面，不能通过把整张地形改成透明材质破坏山体对飞机、航线和尾迹的深度遮挡。
